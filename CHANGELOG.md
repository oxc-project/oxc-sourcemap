...
- *(deps)* upgrade Cargo dependencies ([#476](https://github.com/oxc-project/oxc-sourcemap/pull/476))
...
- *(deps)* update napi ([#469](https://github.com/oxc-project/oxc-sourcemap/pull/469))
- *(deps)* update napi ([#465](https://github.com/oxc-project/oxc-sourcemap/pull/465))
- *(deps)* update napi ([#463](https://github.com/oxc-project/oxc-sourcemap/pull/463))
- *(deps)* update napi to v3.12.5 ([#462](https://github.com/oxc-project/oxc-sourcemap/pull/462))
- *(deps)* update rust crate json-escape-simd to v3.1.2 ([#458](https://github.com/oxc-project/oxc-sourcemap/pull/458))
...
- add fast path for 4 / 5 segments ([#420](https://github.com/oxc-project/oxc-sourcemap/pull/420))
- add encode mappings fast path ([#421](https://github.com/oxc-project/oxc-sourcemap/pull/421))
- update sponsor section ([#417](https://github.com/oxc-project/oxc-sourcemap/pull/417))

## [8.1.1](https://github.com/oxc-project/oxc-sourcemap/compare/v8.1.0...v8.1.1) - 2026-07-12

### Fixed

- clippy 1.97 `byte_char_slices` error ([#408](https://github.com/oxc-project/oxc-sourcemap/pull/408))
...
- _(deps)_ update napi to v3.10.0 ([#391](https://github.com/oxc-project/oxc-sourcemap/pull/391))
- _(deps)_ update napi to v3.9.4 ([#379](https://github.com/oxc-project/oxc-sourcemap/pull/379))
...
- _(concat)_ add owned-merge to ConcatSourceMapBuilder ([#368](https://github.com/oxc-project/oxc-sourcemap/pull/368))

## [8.0.1](https://github.com/oxc-project/oxc-sourcemap/compare/v8.0.0...v8.0.1) - 2026-06-15

### Other

- simplify SourceMapBuilder string storage ([#361](https://github.com/oxc-project/oxc-sourcemap/pull/361))
...
- [**breaking**] add OwnedSourceMap wrapper for downstream owned-only use ([#334](https://github.com/oxc-project/oxc-sourcemap/pull/334))
...
- escape `file` and `sourceRoot` fields ([#294](https://github.com/oxc-project/oxc-sourcemap/pull/294))
...
- _(deps)_ bump napi; bump msrv to 1.88.0 for napi ([#213](https://github.com/oxc-project/oxc-sourcemap/pull/213))
